...
class AllInstrumentsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, AllInstrumentsPresenterDelegate {

    private let presenter = AllInstrumentsPresenter()
    ...
    @objc func deleteButtonTapped(sender: UIButton) {
        ...
        alert.addAction(UIAlertAction(title: "Ok", style: .default, handler: { (action: UIAlertAction!) in
            self.presenter.deleteInstrument(instrumentId: String(self.instruments[sender.tag].id))
        }))
